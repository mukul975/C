var dnaModel = require("./dnaModel.js");
var dnaView = require("./dnaView.js");
var dnaCharts = require("./dnaCharts.js");
            ...
            zip.createWriter(new zip.BlobWriter("application/zip"), function(writer) {
                ...
                function close() {
                    ...
                    writer.close(function(zipfile) {
                        ...
                        FileSaver.saveAs(zipfile, "plots.zip");
                    });
                }
        ...
        document.getElementById("download_charts_txt").addEventListener('click', function (event) {
            ...
            zip.createWriter(new zip.BlobWriter("application/zip"), function(writer) {
                ...
                function close() {
                    ...
                    writer.close(function(zipfile) {
                        // save with FileSaver.js
                        FileSaver.saveAs(zipfile, "shapes.zip");
                    });
                }
        ...
        document.getElementById("download_coords_fra").addEventListener('click', function (event) {
            ...
            zip.createWriter(new zip.BlobWriter("application/zip"), function(writer) {
                ...
                function close() {
                    ...
                    writer.close(function(zipfile) {
                        // save with FileSaver.js
                        FileSaver.saveAs(zipfile, "frames.zip");
                    });
                }
        ...
        document.getElementById("download_coords_bp_fra").addEventListener('click', function (event) {
            ...
            zip.createWriter(new zip.BlobWriter("application/zip"), function(writer) {
                ...
                function close() {
                    ...
                    writer.close(function(zipfile) {
                        // save with FileSaver.js
                        FileSaver.saveAs(zipfile, "bpframes.zip");
                    });
                }
        ...
        document.getElementById("download_coords_pdb").addEventListener('click', function (event) {
            ...
            zip.createWriter(new zip.BlobWriter("application/zip"), function(writer) {
                ...
                function close() {
                    ...
                    writer.close(function(zipfile) {
                        // save with FileSaver.js
                        FileSaver.saveAs(zipfile, "atoms_pdb.zip");
                    });
                }
            ...
            $.when.apply($, promises).then(function() {
                ...
                zip.createWriter(new zip.BlobWriter("application/zip"), function(writer) {
                    ...
                    function close() {
                        ...
                        writer.close(function(zipfile) {
                            // save with FileSaver.js
                            FileSaver.saveAs(zipfile, "stiffness_matrices.zip");
                        });
                    }
...
exports.dnaController = dnaController;
